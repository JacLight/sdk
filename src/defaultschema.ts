...
concreteCollections.set(
  DataType.permission,
  createConcreteCollection(DataType.permission, permissionCollection)
);
concreteCollections.set(
  DataType.usergroup,
...
roles.push(
  createRole(
    'PowerUser',
    'PowerUser users who can view data across the company, cannot change permissions',
    [],
    [],
    []
  )
...
roles.push(
  createRole(
    'Owner',
    'This is an implied role with respect to the objects users create. This role is automatically assigned.',
    [],
    [],
    []
  )
...
roles.push(
  createRole(
    'User',
    'Authenticated users should be assigned this role. This role is automatically assigned.',
    [],
    [],
    []
  )
...
roles.push(
  createRole(
    'Guest',
    'Unauthenticated users always have this role. This role is automatically assigned.',
    [],
    [],
    []
  )
...
groups.push(
  createGroup('Agent', 'Help Desk User Group', ['Reviewer', 'Publisher'])
);
groups.push(
  createGroup('Customer', 'Site users, authenticated users', ['User'])
);
...
const createPermission = (
  ...
  return {
    resourcetype,
    resourceid,
    allow: { view, configure, add, remove },
    deny: {},
  };
};
const adminPermissions: PermissionModel = {
  ownertype: 'role',
  ownerid: 'Administrator',
  permissions: [],
};
adminPermissions.permissions.push(
  createPermission('component', 'site', true, true, true, true)
);
adminPermissions.permissions.push(
  createPermission('component', 'collection', true, true, true, true)
);

const powerPermissions: PermissionModel = {
  ownertype: 'role',
  ownerid: 'PowerUser',
  permissions: [],
};
powerPermissions.permissions.push(
  createPermission('component', 'site', true, true, true, true)
);
powerPermissions.permissions.push(
  createPermission('component', 'collection', true, true, true, true)
...
const reviewerPermissions: PermissionModel = {
  ownertype: 'role',
  ownerid: 'Reviewer',
  permissions: [],
};
reviewerPermissions.permissions.push(
  createPermission('component', 'site', true, true, false, false)
);
reviewerPermissions.permissions.push(
  createPermission('component', 'collection', true, true, false, false)
);

const publisherPermissions: PermissionModel = {
  ownertype: 'role',
  ownerid: 'Publisher',
  permissions: [],
};
publisherPermissions.permissions.push(
  createPermission('component', 'site', true, true, true, false)
);
publisherPermissions.permissions.push(
  createPermission('component', 'collection', true, true, true, false)
);
...
userPermissions.permissions.push(
  createPermission('component', 'site', true, false, false, false)
);
userPermissions.permissions.push(
  createPermission('component', 'collection', true, false, false, false)
);

const guestPermissions: PermissionModel = {
  ownertype: 'role',
  ownerid: 'Guest',
  permissions: [],
};
guestPermissions.permissions.push(
  createPermission('component', 'site', true, false, false, false)
);
guestPermissions.permissions.push(
  createPermission('component', 'collection', true, false, false, false)
