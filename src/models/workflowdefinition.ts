      ...
      action: [
        {
          ...
          targetField:
            '/properties/stages/items/properties/assignTo/dataSource/collection',
      ...
      action: [
        {
          operation: 'setProperty',
          targetField:
            '/properties/tasks/items/properties/assignTo/dataSource/collection',
...
export const WorkflowDefinitionUI = (): CollectionUI[] => {
  return null;
};
